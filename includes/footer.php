        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="ft-logo mb-lg-80">
                    <img src="assets/images/ft-logo.png" class="image-fit" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-3 col-sm-6">
                <div class="footer-widgets mb-sm-80">
                    <h5 class="text-custom-white fw-600">About Us<span class="text-orange">.</span></h5>
                    <ul class="custom">
                        <li>
                            <a href="#">Careers</a>
                        </li>
            ...
            <div class="col-xl-2 col-md-3 col-sm-6">
                <div class="footer-widgets mb-sm-80">
                    <h5 class="text-custom-white fw-600">For Developers<span class="text-orange">.</span></h5>
                    <ul class="custom">
                        <li>
                            <a href="#">Docs</a>
                        </li>
            ...
            <div class="col-xl-2 col-md-3 col-sm-6">
                <div class="footer-widgets mb-xs-80">
                    <h5 class="text-custom-white fw-600">Resources<span class="text-orange">.</span></h5>
                    <ul class="custom">
                        <li>
                            <a href="#">PDF Docs</a>
                        </li>
            ...
            <div class="col-xl-3 col-md-3 col-sm-6">
                <div class="footer-widgets newsletter">
                    <h5 class="text-custom-white fw-600">Subscribe Now<span class="text-orange">.</span></h5>
                    ...
                    <img src="assets/images/iso.png" class="image-fit" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="copyright">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-6">
                <p class="text-custom-white fw-500">Copyright By @ <a href="https://webtend.net/"
                        class="text-custom-white">Webtend</a></p>
            </div>
            <div class="col-lg-4">
